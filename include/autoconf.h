 ...
 */
#define AUTOCONF_TIMESTAMP "2014-05-12 17:03:31 CEST"
...
#define ENABLE_TRACEBOX 1
#ifdef MAKE_SUID
# define IF_TRACEBOX(...) __VA_ARGS__ "CONFIG_TRACEBOX"
#else
# define IF_TRACEBOX(...) __VA_ARGS__
#endif
#define IF_NOT_TRACEBOX(...)
